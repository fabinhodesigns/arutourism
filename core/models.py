...
class Empresa(models.Model):
    ...
    latitude = models.DecimalField(max_digits=30, decimal_places=30, null=True, blank=True)
    longitude = models.DecimalField(max_digits=30, decimal_places=30, null=True, blank=True)
